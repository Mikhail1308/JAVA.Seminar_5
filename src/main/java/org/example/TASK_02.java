...
public class TASK_02 {
    public static void main(String[] args) {
        ...
        System.out.println("Имена с количеством повторений: " + nameMap.toString().replaceAll("" +
                "[{\\}\\{\\}]", ""));
        ...
        System.out.println("Имена по убыванию популярности (количества повторений): " + sortedNameMap.toString().replaceAll("" +
                "[{\\}\\{\\}]", ""));
    }
}